...
const SpeakerCard = () => {
  return (
    <div
      style={
        {
          // boxShadow: "0 3.207px 3.207px 0 rgba(0, 0, 0, 0.25)",
        }
      }
      className="relative w-[280px] bg-[rgba(6,13,37,0.55)] backdrop-blur-[20px] backdrop-saturate-[1.4] rounded-2xl overflow-hidden"
    >
      ...
      <div className="relative z-10 pt-6 pl-6 pr-2 flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 items-start">
          <span className="font-bold text-[28px] leading-tight">Saugat KC</span>
