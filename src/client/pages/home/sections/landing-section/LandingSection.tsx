      ...
      <div className="flex flex-col  space-y-4 ">
        <div className="items-center flex justify-center text-center bg-red">
          <div className="flex items-center gap-2 border-1 bg-red p-2 rounded-full  bg-white/5 backdrop-blur-lg border border-white/10">
            ...
            <div className="flex text-xs items-center">12-13 January, 2025 <ArrowRight size={20} /> </div>{" "}
          </div>
        </div>
        <div className="flex flex-col gap-2 w-[100%] px-[1%]  sm:px-0 sm:w-[80%] md:w-[75%] lg:w-[60%]  text-center mx-auto  ">
          <div className="flex text-[34px] m-auto sm:text-[50px] sm:leading-[46px]  md:text-[64px] font-[600] leading-[37px] px-3 md:leading-[73px] bg-gradient-to-r from-[#DBF5FF]  to-[#51A7FF] bg-clip-text text-transparent -tracking-[2px] ">
