...
<div className="absolute h-[420px] w-14 -left-6 md:hidden overflow-hidden ">
  <div
 ...
 <div className="absolute h-[420px] w-14 -right-6 md:hidden overflow-hidden ">
  <div
    className="h-full w-full translate-x-1/2 rounded-full
  ...
  ></div>
      ...
      <div className="flex justify-evenly">
        ...
        <div
          className="flex flex-col items-center text-center md:flex-row md:items-stretch "
        >
