...
export const Footer = () => {
  ...
  return (
    <footer className="mx-auto max-w-[1112px] px-4 sm:px-6">
 <div className="flex flex-col items-center gap-6 md:flex-row md:justify-between md:items-start md:gap-0">
      ...
      >
        ...
        />
                      ...
                      <div className="text-center md:text-left">
                        <h1 className="text-[#50A6FE] font-sans font-bold">
                          Contact Us
                        </h1>
                 ...
                 <ul className="mt-[5px] flex flex-row sm:flex-row md:flex-col gap-6 md:gap-3 justify-center md:justify-start list-none p-0 m-0">   <li><a href="#" className="md:mt-[17px] flex items-center gap-[10px]"><span>
    ...
    <defs>
      <clipPath id="clip0_3050_1079">
        <path fill="#fff" d="M0 0h20v20H0z"></path>
                    ...
                    </span><span className="hidden sm:inline">Facebook</span></a></li>


                      <li><a href="#" className="md:mt-[5px] flex items-center gap-[12px] "><span>
  ...
  >
    ...
    ></path>
                    ...
                    </span><span className="hidden sm:inline">Instagram</span></a></li>
...
>
  ...
  />
</svg>      </span> <span className="hidden tracking-wide sm:inline">LinkedIn</span></a></li></ul>
  ...
  <div className="flex  flex-row items-center md:items-center gap-2 md:gap-[18px]">
    <p className="font-normal text-[14px] md:text-[16px]">Organized by:</p>
    <img src={PrimeITClub} alt="Prime IT Club Logo" className="h-6 md:h-auto" />
  </div>
  <div className="flex flex-row items-center md:items-center gap-2 md:gap-[18px] mt-[27px]">
    <p className="font-normal text-[14px] md:text-[16px]">Supported By:</p>
    <img src={PrimeCollege} alt="Prime College" className="h-6 md:h-auto" />
  </div>
...
<path d="M8.2599 2.58691L8.2599 21.2298M8.2599 2.58691L15.251 8.32318M8.2599 2.58691L1.26883 8.32318" stroke="white" stroke-width="4"/>
</svg>
      ...
      <div className="relative mt-12 overflow-hidden text-center">
        <h1 className="font-extrabold bg-gradient-to-b from-[#DBF5FF] via-[#007AFF] to-[#04143B] bg-clip-text text-transparent text-5xl sm:text-7xl md:text-[170px] leading-tight">ICT MEETUP</h1>
