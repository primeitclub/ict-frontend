...
import type { ContentType } from "../pages/home/sections/highlight-section/HighlightSection";
  ...
  return (
    <div className=" rounded-3xl  bg-[#FEFEFE] p-3 group h-full font-sans">
      <div className="relative h-44 w-full rounded-2xl overflow-hidden">
        ...
        />
        <div className="absolute top-3 left-3 bg-[#970B0B] text-sm font-bold px-2.5 py-1 rounded-md text-white shadow-lg">
